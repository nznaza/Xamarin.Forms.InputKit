...
namespace Plugin.InputKit.Shared.Controls
{
    ...
    public partial class AdvancedEntry : StackLayout, IValidatable
    {
        ...
        readonly Frame frmBackground = new Frame { BackgroundColor = GlobalSetting.BackgroundColor, CornerRadius = (float)GlobalSetting.CornerRadius, BorderColor = GlobalSetting.BorderColor, Padding = new Thickness(5, 0, 0, 0), HasShadow = false, VerticalOptions= LayoutOptions.CenterAndExpand };
